...
insert into teachers (id, auth_user_id, name, email, role, display_order) values
  ...
  ('44444444-4444-4444-8444-444444444444', null, 'Hugo Amador', 'amadorhugo31@gmail.com', 'teacher', 4),
  ...
  ('77777777-7777-4777-8777-777777777777', null, 'Lohan Amador', 'lohanamador66@gmail.com', 'teacher', 7),

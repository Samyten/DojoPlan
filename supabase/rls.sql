...
-- Visitors may see only the timetable columns granted below. RLS opens the rows, while
-- column privileges keep lesson content, notes and timestamps private.
...
-- Defense in depth: anonymous visitors never need teacher, availability or audit data.
